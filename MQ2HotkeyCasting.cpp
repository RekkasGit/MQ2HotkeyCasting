...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnCleanUI()");
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnReloadUI()");
}
...
/*
	...
	if (std::chrono::steady_clock::now() > DrawHUDTimer)
	{
		...
		DebugSpewAlways("MQ2HotkeyCasting::OnDrawHUD()");
	}
*/
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::SetGameState(%d)", GameState);
}
...
/*
	...
	if (std::chrono::steady_clock::now() > PulseTimer)
	{
		...
		DebugSpewAlways("MQ2HotkeyCasting::OnPulse()");
	}
*/
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnWriteChatColor(%s, %d, %d)", Line, Color, Filter);
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnIncomingChat(%s, %d)", Line, Color);
	return false;
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnAddSpawn(%s)", pNewSpawn->Name);
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnRemoveSpawn(%s)", pSpawn->Name);
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnAddGroundItem(%d)", pNewGroundItem->DropID);
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnRemoveGroundItem(%d)", pGroundItem->DropID);
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnBeginZone()");
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnEndZone()");
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnZoned()");
}
...
/*
	...
	{
		if (ShowMQ2HotkeyCastingWindow)
		{
			if (ImGui::Begin("MQ2HotkeyCasting", &ShowMQ2HotkeyCastingWindow, ImGuiWindowFlags_MenuBar))
			{
				if (ImGui::BeginMenuBar())
				{
					ImGui::Text("MQ2HotkeyCasting is loaded!");
					ImGui::EndMenuBar();
				}
			}
			ImGui::End();
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnMacroStart(%s)", Name);
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnMacroStop(%s)", Name);
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnLoadPlugin(%s)", Name);
}
...
{
	// DebugSpewAlways("MQ2HotkeyCasting::OnUnloadPlugin(%s)", Name);
}